...
* **If missing**:
  ...
  * It prompts you with a VS Code dialog: *"No langgraph.json configuration file was found in your workspace root. Would you like to automatically generate one?"*
...
* *Note: Closing the VS Code window or workspace automatically shuts down the background server process.*
